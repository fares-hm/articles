            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('articles.update',$article->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="article_title" type="text" class="form-control" name="article_title" autofocus value="{{$article->article_title}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="article_author" type="text" class="form-control" name="article_author" autofocus value="{{$article->article_author}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="article_cat" type="text" class="form-control" name="article_cat" autofocus value="{{ArticleController::getArticleCategory($article->article_cat_id)->category_name}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="article_content" type="text" class="form-control" name="article_content" autofocus value="{{$article->article_content}}">
